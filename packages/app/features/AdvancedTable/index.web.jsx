...
const TableData = [
  {
    tableHead: 'Apple iMac 27"',
    tableData: ['PC', 'Apple', '300', '$2999'],
  },
  {
    tableHead: 'Apple iMac 20"',
    tableData: ['PC', 'Apple', '200', '$1499'],
  },
  {
    tableHead: 'Apple iPhone 14',
    tableData: ['Phone', 'Apple', '1237', '$999'],
  },
  {
    tableHead: 'Apple iPad Air',
    tableData: ['Tablet', 'Apple', '4578', '$1199'],
  },
  {
    tableHead: 'Xbox Series S',
    tableData: ['Gaming/Console', 'Microsoft', '56', '$299'],
  },
  {
    tableHead: 'PlayStation 5',
    tableData: ['Gaming/Console', 'Sony', '78', '$799'],
  },
  {
    tableHead: 'Xbox Series X',
    tableData: ['Gaming/Console', 'Microsoft', '200', '$699'],
  },
  {
    tableHead: 'Apple Watch SE',
    tableData: ['Watch', 'Apple', '657', '$399'],
  },
  {
    tableHead: 'NIKON D850',
    tableData: ['Photo', 'Nikon', '465', '$599'],
  },
]
      ...
      <div class="flex flex-col items-center justify-between space-y-3 p-4 md:flex-row md:space-x-4 md:space-y-0">
        ...
        <div class="flex w-full flex-shrink-0 flex-col items-stretch justify-end space-y-2 md:w-auto md:flex-row md:items-center md:space-x-3 md:space-y-0">
          ...
          <div class="flex w-full items-center space-x-3 md:w-auto">
            <div class="relative flex w-full items-center justify-center space-x-3 md:w-auto">
              <button
                onClick={() => {
                  setOpenFilter(false)
              ...
              <div
                ...
                class={`z-10 ${
                  !openAction && 'hidden'
                } absolute top-12 w-44 divide-y divide-gray-100 rounded bg-white shadow dark:divide-gray-600 dark:bg-gray-700`}
              >
                <ul
            ...
            <div class="relative flex w-full items-center justify-center space-x-3 md:w-auto">
              ...
              <div
                id="filterDropdown"
                class={`absolute z-10 sm:max-md:bottom-12 md:top-12 ${
                  !openFilter && 'hidden'
                } w-48 rounded-lg bg-white p-3 shadow dark:bg-gray-700`}
              >
...
const TableRow = ({ tableHead, tableData = [], up = false }) => {
  const [open, setOpen] = useState(false)
  return (
    <tr class="z-50 border-b dark:border-gray-700">
      <th
        scope="row"
      ...
      {tableData.map((item, index) => (
        <td key={index} class="px-4 py-3">
          {item}
        </td>
      ))}

      <td class="relative flex items-center justify-end px-4 py-3">
        <button
        ...
        <div
          class={`z-50 ${!open && 'hidden'} absolute right-0 ${
            up ? 'bottom-10' : 'top-10'
          } w-44 divide-y divide-gray-100 rounded bg-white shadow dark:divide-gray-600 dark:bg-gray-700`}
        >
          <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
            {['Show', 'Edit'].map((item, index) => (
              <li key={index}>
                <a
                  href="#"
                  class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
...
const AdvancedTable = ({TableHeaders=headers}) => {
  return (
    <section class="h-screen bg-gray-50  p-3 dark:bg-gray-900 sm:p-5">
      <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
          <TableHeader filterTitle="Choose brand" filterItems={filterItems} />
          <div class="overflow-x-auto">
            <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
              <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  {TableHeaders.map((item, index) => (
                    <th key={index} scope="col" class="px-4 py-3">
                      {item}
                    </th>
                  ))}
            ...
            <ul class="inline-flex items-stretch -space-x-px">
              ...
              <li>
                <a
                  href="#"
                  aria-current="page"
                  class="text-primary-600 bg-primary-50 border-primary-300 hover:bg-primary-100 hover:text-primary-700 z-10 flex items-center justify-center border px-3 py-2 text-sm leading-tight dark:border-gray-700 dark:bg-gray-700 dark:text-white dark:hover:text-white"
                >
                  3
                </a>
              </li>
